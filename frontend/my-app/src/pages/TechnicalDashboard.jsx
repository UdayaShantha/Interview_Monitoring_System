...
import { FaDatabase, FaChartBar, FaCode, FaTools, FaCogs,FaReact, FaAngular, FaNodeJs } from "react-icons/fa";
  ...
  return (
    ...
    >
      ...
      <nav className="bg-gradient-to-r from-green-900 to-green-700 text-white p-5 flex justify-between items-center shadow-lg">
        <h1 className="text-3xl font-bold tracking-wide"> Technical Dashboard</h1>
